...
/**
 * Data monitor, will watch the path's create/change/delete events. The zk client must has the READ
 * permission with the path.
 *
 * @author hebelala
 */
public class DataMonitor extends AbstractMonitor implements Watcher, AsyncCallback.StatCallback,
