...
public final class FileUtils {
  ...
  public static void unzipToDirectory(File file, File directory) throws IOException {
    ...
    while (entries.hasMoreElements()) {
      ...
      File temp = new File(directory.getCanonicalPath() + File.separator + zipEntry.getName()
   ...
   */
  public static void zipToFile(List<File> fileList, File file, String baseDirectory)
      throws IOException {
