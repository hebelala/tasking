...
public class RunMojo extends ResolveArtifactMojo {
  ...
  public void execute() throws MojoExecutionException {
    ...
    try {
      ...
      // If tasking-api is SNAPSHOT, or the cache is not existing, then download tasking-container and cover it to cache.
      ...
      if (taskingApiVersion.toUpperCase().endsWith("SNAPSHOT") || !tcFileCached.exists()) {
        File tcFile = resolveArtifact("com.github.hebelala", "tasking-container", taskingApiVersion,
            "zip", "zip");
