...
public abstract class ResolveArtifactMojo extends TaskingMojo {
  ...
  protected File resolveArtifact(String groupId, String artifactId, String version, String type,
  ...
  private ArtifactCoordinate toArtifactCoordinate(DependableCoordinate dependableCoordinate) {
    ArtifactHandler artifactHandler = artifactHandlerManager
        .getArtifactHandler(dependableCoordinate.getType());
