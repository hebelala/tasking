...
public abstract class ResolveArtifactMojo extends AbstractMojo {
    ...
    protected File resolveArtifact(String groupId, String artifactId, String version, String type, String classifier) throws MojoExecutionException {
        ...
        try {
            ...
            ArtifactResult resolveArtifact = artifactResolver.resolveArtifact(buildingRequest, toArtifactCoordinate(coordinate));
